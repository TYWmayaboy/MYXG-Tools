...
-(void)alertUserCommentView:(UIViewController *)VC{
    ...
    if ([[[UIDevice currentDevice] systemVersion] floatValue] >= 8.0) {
        ...
        alertController = [UIAlertController alertControllerWithTitle:@"您的评价对我们很重要" message:@"您的支持是我们前进的动力，前去评论吧！！！" preferredStyle:(UIAlertControllerStyleAlert)];
...
//        NSLog(@"%@",[userDefaults objectForKey:@"theDays"]);
        ...
        alertViewTest = [[UIAlertView alloc] initWithTitle:@"您的评价对我们很重要" message:@"您的支持是我们前进的动力，前去评论吧！！！" delegate:self cancelButtonTitle:@"😭残忍拒绝" otherButtonTitles:@"😄好评赞赏",@"😓我要吐槽", nil];
        [alertViewTest show];
        #endif
    }
